  ...
  var Pi = u(() => {
    window.tram = (function (e) {
      ...
      function c(l, v, y) {
        ...
        var T = y
        return (
          qt.test(l) || !vt.test(l) ? (T = parseInt(l, 10)) : vt.test(l) && (T = 1e3 * parseFloat(l)),
          0 > T && (T = 0),
          T === T ? T : y
        )
      }
      ...
      var p = (function (l, v, y) {
        ...
        h = {
          ease: [
            ...
            function (l, v, y, T) {
              var _ = (l /= T) * l,
                O = _ * l
              return v + y * (-2.75 * O * _ + 11 * _ * _ + -15.5 * O + 8 * _ + 0.25 * l)
            },
          ],
          'ease-in': [
            'ease-in',
          ...
          'ease-out': [
            ...
            function (l, v, y, T) {
              var _ = (l /= T) * l,
                O = _ * l
              return v + y * (0.3 * O * _ + -1.6 * _ * _ + 2.2 * O + -1.8 * _ + 1.9 * l)
            },
          ],
          'ease-in-out': [
            'ease-in-out',
        ...
        M = function (l) {
          ...
          for (v = 0; v < m.length; v++) if (((y = m[v] + T), y in D.style)) return { dom: y, css: P[v] + l }
        },
        X = (t.support = {
      ...
      if (X.transition) {
        var $ = X.timing.dom
        if (((D.style[$] = h['ease-in-back'][0]), !D.style[$])) for (var te in g) h[te][0] = g[te]
      }
      var L = (t.frame = (function () {
        ...
        k = p(function (l) {
          ...
          function y(Z, fe, Ie) {
            if (Z) {
              var pe = typeof Z
              if (
                (fe || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)),
                pe == 'number' && fe)
              )
                return (this.timer = new Ee({ duration: Z, context: this, complete: O })), void (this.active = !0)
              if (pe == 'string' && fe) {
                switch (Z) {
                  case 'hide':
                    W.call(this)
          ...
          function T(Z) {
            ;(Z = c(Z, 0)),
              this.active
                ...
                : ((this.timer = new Ee({ duration: Z, context: this, complete: O })), (this.active = !0))
          }
          function _(Z) {
            return this.active
              ? (this.queue.push({ options: Z, args: arguments }), void (this.timer.complete = O))
          ...
          function z(Z) {
            ...
            var fe
            typeof Z == 'string' ? ((fe = {}), (fe[Z] = 1)) : (fe = typeof Z == 'object' && Z != null ? Z : this.props),
              rt.call(this, fe, Pe),
              Se.call(this)
          }
          function re(Z) {
          ...
          function rt(Z, fe, Ie) {
            ...
            for (pe in Z)
              (je = Z[pe]),
                pe in _e
                  ? (be.transform || (be.transform = {}), (be.transform[pe] = je))
                  : (w.test(pe) && (pe = r(pe)), pe in B ? (be[pe] = je) : (Xe || (Xe = {}), (Xe[pe] = je)))
            for (pe in be) {
        ...
        F = p(function (l) {
          ...
          ;(l.init = function (O, z, re, he) {
            ...
            (l.fallback = function (O) {
              ...
              ;(O = this.convert(O, this.type)),
                this.auto &&
                  (z == 'auto' && (z = this.convert(this.get(), this.type)), O == 'auto' && (O = v.call(this))),
                (this.tween = new J({
                  from: z,
                  to: O,
        ...
        ce = p(F, function (l, v) {
          function y(T, _) {
            var O, z, re, he, W
            for (O in T)
              (he = _e[O]), (re = he[0]), (z = he[1] || O), (W = this.convert(T[O], re)), _.call(this, z, W, re)
          }
          ;(l.init = function () {
            ...
            (l.values = function (T) {
              var _,
                O = {}
              return (
                y.call(this, T, function (z, re, he) {
                  ;(O[z] = re),
                    this.current[z] === void 0 &&
                      ((_ = 0), ~z.indexOf('scale') && (_ = 1), (this.current[z] = this.convert(_, he)))
                }),
                O
              )
            })
        ...
        J = p(function (l) {
          ...
          function y() {
            var W,
              ...
              le,
              Se = re.length
            if (Se) for (L(y), se = H(), W = Se; W--; ) (le = re[W]), le && le.render(se)
          }
          function T(W) {
            var se,
              le = e.inArray(W, re)
          ...
          ;(l.init = function (W) {
            ...
            (l.render = function (W) {
              ...
              if (le < this.duration) {
                ...
                return (
                  (se = this.startRGB ? O(this.startRGB, this.endRGB, Se) : _(this.begin + Se * this.change)),
          ...
          ;(l.init = function (y) {
            ...
            (l.render = function (y) {
              var T,
                ...
                z = !1
              for (T = O; T--; )
                (_ = this.tweens[T]), _.context && (_.render(y), (this.current[_.name] = _.value), (z = !0))
      ...
      X.transform &&
        ...
        X.transform &&
          X.backface &&
          ((_e.z = [q, 'translateZ']), (_e.rotateZ = [G]), (_e.scaleZ = [I]), (_e.perspective = [C]))
      var qt = /ms/,
        vt = /s|\./
      return (e.tram = t)
    })(window.jQuery)
  ...
  var ys = u((rW, _s) => {
    ...
    _s.exports = (function () {
          ...
          e.forEach =
            function (m, P, M) {
              ...
              if (E && m.forEach === E) m.forEach(P, M)
                ...
                for (var X = 0, $ = m.length; X < $; X++) if (P.call(M, m[X], X, m) === t) return
              } else
      ...
      var j = /(.)^/,
        ...
        D = /^\s*(\w|\$)+\s*$/
      return (
        (e.template = function (m, P, M) {
          !P && M && (P = M), (P = e.defaults({}, P, e.templateSettings))
          var X = RegExp(
              [(P.escape || j).source, (P.interpolate || j).source, (P.evaluate || j).source].join('|') + '|$',
              'g'
            ),
            $ = 0,
            te = "__p+='"
...
` +
  ...
  var Ye = u((nW, ws) => {
    ...
    function Ts(e) {
      ve.env() && (nt(e.design) && ze.on('__wf_design', e.design), nt(e.preview) && ze.on('__wf_preview', e.preview)),
    ...
    var sn = navigator.userAgent.toLowerCase(),
      ...
      pm = (ve.env.chrome =
        /chrome/.test(sn) && /Google/.test(navigator.vendor) && parseInt(sn.match(/chrome\/(\d+)\./)[1], 10)),
      ...
      (Cs.exports = function (e) {
        ...
        t.ready = function () {
          ...
          ;/\.webflow\.io$/i.test(S) && a.hostname !== S && (g = !0),
            g && !s && ((f = f || p()), h(), setTimeout(h, 500), e(r).off(c, E).on(c, E))
        }
        function E() {
          var g =
            r.fullScreen ||
  ...
  var xs = u((oW, qs) => {
    ...
    Xi.define(
      ...
      (qs.exports = function (e, t, r) {
        if (((r = r || {}), (Xi.env('test') || Xi.env('frame')) && !r.fixture && !gm())) return { exit: 1 }
        var n = {},
          i = e(window),
        ...
        E
          ? f()
          : a.search
          ? (/[?&](edit)(?:[=&?]|$)/.test(a.search) || /\?edit$/.test(a.href)) && f()
        ...
        function S(N, C) {
          e.ajax({ type: 'GET', url: N, dataType: 'script', cache: !0 }).then(C, b)
        }
        function b(N, C, q) {
        ...
        function w(N) {
          ...
          var q = function (G) {
            G.data === 'WF_third_party_cookies_unsupported'
              ? (I(C, q), N(!1))
              : G.data === 'WF_third_party_cookies_supported' && (I(C, q), N(!0))
          }
          ;(C.onerror = function () {
            I(C, q), N(!1)
          }),
  ...
  var Us = u((uW, Xs) => {
    ...
    it.triggers = {}
    it.types = { INTRO: 'w-ix-intro' + Gs, OUTRO: 'w-ix-outro' + Gs }
    it.init = function () {
  ...
  var Wi = u((cW, Bs) => {
    ...
    fn.triggers = {}
    fn.types = { INTRO: 'w-ix-intro' + Ws, OUTRO: 'w-ix-outro' + Ws }
  ...
  var Kt = u((fW, Or) => {
    ...
    function Tm(e, t) {
      ...
      if (e === null || (Im(e) !== 'object' && typeof e != 'function')) return { default: e }
      var r = ks(t)
  ...
  var Ou = u((CW, Tu) => {
    ...
    !vn &&
      $i &&
      ((Qe = $i.match(/Edge\/(\d+)/)), (!Qe || Qe[1] >= 74) && ((Qe = $i.match(/Chrome\/(\d+)/)), Qe && (vn = +Qe[1])))
    Tu.exports = vn
  })
  var Qi = u((NW, bu) => {
    var Su = Ou(),
  ...
  var wc = u((nB, Ac) => {
    ...
    var Tt, Oc, _o, Sc, Dt
    Ac.exports = { set: yn, get: Nr, has: mn, enforce: _T, getterFor: yT }
  })
  var Nc = u((iB, Cc) => {
    var mo = Lt(),
      mT = It(),
    ...
    Cc.exports = { EXISTS: Io, PROPER: TT, CONFIGURABLE: OT }
  })
  var Dc = u((oB, Pc) => {
    var ST = me(),
      qc = at(),
    ...
    ;(Pc.exports = function (e, t, r, n) {
      ...
      if (
        (qc(r) &&
          ...
          (!bT(r, 'name') || (RT && r.name !== s)) && xc(r, 'name', s),
          (c = NT(r)),
    ...
    il.exports = function (e, t) {
      ...
      if ((n ? (a = Ao) : i ? (a = Ao[r] || hO(r, {})) : (a = (Ao[r] || {}).prototype), a))
        for (s in t) {
          if (
            ((f = t[s]),
            e.noTargetGet ? ((E = pO(a, s)), (c = E && E.value)) : (c = a[s]),
            (o = _O(n ? s : r + (i ? '.' : '#') + s, e.forced)),
            !o && c !== void 0)
          ) {
  ...
  var yl = u((TB, _l) => {
    ...
    _l.exports =
      ...
      function (t, r) {
        var n
        return (
          t !== null ? ((wo[Ro] = wO(t)), (n = new wo()), (wo[Ro] = null), (n[hl] = t)) : (n = On()),
          r === void 0 ? n : RO(n, r)
        )
      }
  })
  var Il = u((OB, ml) => {
    var PO = oo(),
      ...
      No = PO('unscopables'),
      qo = Array.prototype
    qo[No] == null && MO.f(qo, No, { configurable: !0, value: DO(null) })
  ...
  var Xo = u((Lr) => {
    ...
    var Ql = (Lr.ActionTypes = { INIT: '@@redux/INIT' })
    function Jl(e, t, r) {
      var n
        ...
        if (typeof r(void 0, { type: i }) > 'u')
          throw new Error(
            'Reducer "' +
              ...
              ("Don't try to handle " + ef.ActionTypes.INIT + ' or other actions in "redux/*" ') +
      ...
      return function (n) {
        return function (i, o, a) {
          ...
          return (
            ...
            (c = XS.default.apply(void 0, f)(s.dispatch)),
            FS({}, s, { dispatch: c })
          )
        }
      }
  ...
  var sf = u((Ce) => {
    ...
    var eb = { ELEMENT: 'ELEMENT', CLASS: 'CLASS', PAGE: 'PAGE' }
    Ce.EventAppliesTo = eb
    var tb = { ELEMENT: 'ELEMENT', VIEWPORT: 'VIEWPORT' }
    Ce.EventBasedOn = tb
    var rb = { X_AXIS: 'X_AXIS', Y_AXIS: 'Y_AXIS' }
    Ce.EventContinuousMouseAxes = rb
    var nb = { CHILDREN: 'CHILDREN', SIBLINGS: 'SIBLINGS', IMMEDIATE_CHILDREN: 'IMMEDIATE_CHILDREN' }
  ...
  var zo = u((er) => {
    ...
    var sb = { ELEMENT: 'ELEMENT', ELEMENT_CLASS: 'ELEMENT_CLASS', TRIGGER_ELEMENT: 'TRIGGER_ELEMENT' }
  ...
  var cf = u((bn) => {
    ...
    var cb = zo(),
      ...
      gb = { [lb]: !0, [fb]: !0, [db]: !0, [pb]: !0, [vb]: !0, [Eb]: !0, [hb]: !0 }
  ...
  var tr = u((Te) => {
        ...
        if (f != null) {
          ...
          if (E.length)
            for (var p = 0; p <= E.length; p++) {
              ...
              if (!(e && n[h] !== void 0)) {
                var g = f[h]
                t && Rn(n[h]) && Rn(g) && (g = Ve(e, t, n[h], g)),
                  !(g === void 0 || g === n[h]) && (i || ((i = !0), (n = Cn(n))), (n[h] = g))
              }
            }
        }
      }
    ...
    function Rf(e, t, r, n, i, o, a) {
      var s = Nn(e, t)
      s == null && (s = {})
      for (var c = void 0, f = arguments.length, E = Array(f > 7 ? f - 7 : 0), p = 7; p < f; p++)
        E[p - 7] = arguments[p]
      return (
        E.length
          ? (c = Ve.call.apply(Ve, [null, !1, !1, s, r, n, i, o, a].concat(E)))
          : (c = Ve(!1, !1, s, r, n, i, o, a)),
        xn(e, t, c)
      )
    }
    function Cf(e, t) {
      ...
      h0 = (e = Lf, t) => {
        switch (t.type) {
          ...
          case p0: {
            ...
            return (0, st.merge)(e, { viewportWidth: r, mediaQueryKey: o })
          }
          case v0:
  ...
  var xd = u((FH, qd) => {
    var Nd = Cd(),
      ...
      Ww = Mn()
    function Bw() {
      ;(this.size = 0), (this.__data__ = { hash: new Nd(), map: new (Ww || Vw)(), string: new Nd() })
    }
    qd.exports = Bw
  })
  var Pd = u((GH, Ld) => {
    ...
    function HN(e, t, r, n, i, o) {
      ...
      if (b && !x) {
        ...
        N != C &&
          'constructor' in e &&
          'constructor' in t &&
          !(typeof N == 'function' && N instanceof N && typeof C == 'function' && C instanceof C) &&
          (b = !1)
      }
  ...
  var jn = u((N5, _v) => {
    var pa = av(),
      ...
      uq = ur(ga),
      Ft = gv
    ;((pa && Ft(new pa(new ArrayBuffer(1))) != hv) ||
      (va && Ft(new va()) != dv) ||
      (Ea && Ft(Ea.resolve()) != pv) ||
      (ha && Ft(new ha()) != vv) ||
      (ga && Ft(new ga()) != Ev)) &&
  ...
  var zn = u((X5, Xv) => {
    ...
    function Uq(e, t) {
      if (Mq(e)) return !1
      var r = typeof e
      return r == 'number' || r == 'symbol' || r == 'boolean' || e == null || Fq(e)
        ? !0
        : Xq.test(e) || !Gq.test(e) || (t != null && e in Object(t))
    }
    Xv.exports = Uq
  })
  var Wv = u((U5, Vv) => {
  ...
  var Ca = u((Ek, HE) => {
    ...
    HE.exports = function (t, r, n, i) {
      ...
      if (t !== r || n !== i) for (var a = 0; a < jr; ++a) o[a] = ri(a * ti, t, n)
      function s(c) {
  ...
  var Na = u((ne) => {
    ...
    var ni = XL(Ca()),
      _t = 1.70158,
      UL = (0, ni.default)(0.25, 0.1, 0.25, 1)
    ne.ease = UL
    var VL = (0, ni.default)(0.42, 0, 1, 1)
    ne.easeIn = VL
    var WL = (0, ni.default)(0, 0, 0.58, 1)
    ne.easeOut = WL
    var BL = (0, ni.default)(0.42, 0, 0.58, 1)
    ne.easeInOut = BL
    function HL(e) {
      return Math.pow(e, 2)
    }
  ...
  var YE = u((lr) => {
    ...
    var ii = tr(),
      ...
      { IX2_SESSION_STOPPED: FP, IX2_INSTANCE_ADDED: GP, IX2_ELEMENT_STATE_CHANGED: XP } = KE.IX2EngineActionTypes,
      jE = {},
      UP = 'refState',
      VP = (e = jE, t = {}) => {
        switch (t.type) {
          ...
          case GP: {
            let { elementId: r, element: n, origin: i, actionItem: o, refType: a } = t.payload,
              { actionTypeId: s } = o,
              c = e
            return (0, ii.getIn)(c, [r, n]) !== n && (c = zE(c, n, a, r, o)), La(c, r, s, i, o)
          }
          case XP: {
  ...
  var yh = u((oi) => {
    ...
    function FD(e, t) {
      ...
      for (let i = 0; i < r.length; i++) if (!MD.call(t, r[i]) || !_h(e[r[i]], t[r[i]])) return !1
      return !0
    }
    var GD = FD
    oi.default = GD
  ...
  var Uh = u((ge) => {
    ...
    var At = ui(JE()),
      ...
      tM = 'OBJECT_VALUE',
      Ph = (e) => e.trim(),
      Va = Object.freeze({ [hr]: Nh, [gr]: $D, [_r]: QD }),
      Dh = Object.freeze({ [Fe.TRANSFORM_PREFIXED]: VD, [Nh]: UD, [ai]: ai, [zr]: zr, [ct]: ct, [lt]: lt, [Yr]: Yr }),
      Sh = {},
      rM = 1
    function nM() {
      return 'i' + rM++
    ...
    function Wa({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: i }) {
      ...
      if (Array.isArray(c) && c.length > 0)
        return c.reduce(
          (M, X) => M.concat(Wa({ config: { target: X }, event: t, eventTarget: r, elementRoot: n, elementApi: i })),
          []
        )
      let {
          getValidDocument: f,
        ...
        { target: A } = e
      if (!A) return []
      let { id: w, objectId: I, selector: N, selectorGuids: C, appliesTo: q, useEventTarget: G } = bh(A)
      ...
      let Y =
          ((o =
            t == null || (a = t.action) === null || a === void 0 || (s = a.config) === null || s === void 0
              ? void 0
      ...
      if (
        (ie
          ? ((ee = Y.limitAffectedElements), (D = P), (m = E(Y)))
    ...
    var Ah = /px/,
      ...
      fM = (e, t) =>
        t.reduce((r, n) => (r[n.type] == null && (r[n.type] = mM[n.type] || n.defaultValue || 0), r), e || {})
    function dM(e, t = {}, r = {}, n, i) {
      ...
      switch (n.actionTypeId) {
        ...
        case Lh:
          return { value: (0, At.default)(parseFloat(o(e, ai)), 1) }
        case Er: {
          let s = o(e, ct),
            c = o(e, lt),
            f,
          ...
          return (
            n.config.widthUnit === wt
              ? (f = Ah.test(s) ? parseFloat(s) : parseFloat(r.width))
              : (f = (0, At.default)(parseFloat(s), parseFloat(r.width))),
            n.config.heightUnit === wt
              ? (E = Ah.test(c) ? parseFloat(c) : parseFloat(r.height))
              : (E = (0, At.default)(parseFloat(c), parseFloat(r.height))),
        ...
        case gr:
        case _r:
          return qM({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: o })
        case ci:
          return { value: (0, At.default)(o(e, si), r.display) }
        case tM:
    ...
    var pM = (e, t) => (t && (e[t.type] = t.value || 0), e),
      ...
      EM = (e, t, r) => {
        ...
        switch (e) {
          case Zr: {
            let n = (0, Fa.default)(r.filters, ({ type: i }) => i === t)
            return n ? n.value : 0
          }
          case Jr: {
            let n = (0, Fa.default)(r.fontVariations, ({ type: i }) => i === t)
            return n ? n.value : 0
          }
          default:
            return r[t]
    ...
    function xM(e, t, r, n, i, o) {
      ...
      switch (n.actionTypeId) {
        case Er: {
          ...
          f !== void 0 && (s === wt && (s = 'px'), Vt(e, ct, o), a(e, ct, f + s)),
        ...
        case _r: {
          let s = Va[n.actionTypeId],
            ...
            p = r.aValue
          Vt(e, s, o), a(e, s, p >= 1 ? `rgb(${c},${f},${E})` : `rgba(${c},${f},${E},${p})`)
          break
        }
        default: {
          let { unit: s = '' } = n.config
    ...
    function LM(e, t, r) {
      ...
      switch (t.actionTypeId) {
        case ci: {
          ...
          i === YD && Fe.IS_BROWSER_ENV ? n(e, si, Fe.FLEX_PREFIXED) : n(e, si, i)
          return
        }
      }
    }
    ...
    function wh({ actionList: e = {}, event: t, elementApi: r }) {
      ...
      n &&
        n.forEach((o) => {
          Rh({ actionGroup: o, event: t, elementApi: r })
        }),
        i &&
          i.forEach((o) => {
            let { continuousActionGroups: a } = o
            a.forEach((s) => {
              Rh({ actionGroup: s, event: t, elementApi: r })
            })
          })
    }
    function Rh({ actionGroup: e, event: t, elementApi: r }) {
      let { actionItems: n } = e
      n.forEach(({ actionTypeId: i, config: o }) => {
        let a
        ;(0, ft.isPluginType)(i)
          ? (a = (0, ft.clearPlugin)(i))
          : (a = Gh({ effect: MM, actionTypeId: i, elementApi: r })),
          Wa({ config: o, event: t, elementApi: r }).forEach(a)
      })
    }
    function DM(e, t, r) {
      ...
      i(e, fr) && Gh({ effect: Fh, actionTypeId: o, elementApi: r })(e)
    }
    var Gh =
    ...
    function GM({ actionList: e, actionItemId: t, rawData: r }) {
      let { actionItemGroups: n, continuousParameterGroups: i } = e,
        o = [],
        a = (s) => (o.push((0, mh.mergeIn)(s, ['config'], { delay: 0, duration: 0 })), s.id === t)
      return (
        ...
        (0, mh.setIn)(r, ['actionLists'], { [e.id]: { id: e.id, actionItemGroups: [{ actionItems: o }] } })
      )
    }
    function XM(e, { basedOn: t }) {
      return (
        (e === Ut.EventTypeConsts.SCROLLING_IN_VIEW && (t === Ut.EventBasedOn.ELEMENT || t == null)) ||
  ...
  var Hh = u((fi) => {
    ...
    var Vh = Ue(),
      ...
      { optimizeFloat: li, applyEasing: Bh, createBezierEasing: rF } = Wh.IX2EasingUtils,
      { RENDER_GENERAL: nF } = Vh.IX2EngineConstants,
      { getItemConfigByKey: Ha, getRenderType: iF, getStyleProp: oF } = Wh.IX2VanillaUtils,
      aF = (e, t) => {
        let {
            position: r,
            parameterId: n,
        ...
        for (let j = 0, { length: Y } = i; j < Y; j++) {
          let { keyframe: ie, actionItems: ee } = i[j]
          if ((j === 0 && (I = ee[0]), w >= ie)) {
            I = ee[0]
            let D = i[j + 1],
              m = D && w !== ie
  ...
  var kh = u((di) => {
    ...
    var cF = Ue(),
      { IX2_RAW_DATA_IMPORTED: lF, IX2_SESSION_STOPPED: fF, IX2_PARAMETER_CHANGED: dF } = cF.IX2EngineActionTypes,
      pF = (e = {}, t) => {
        switch (t.type) {
          case lF:
  ...
  var jh = u((pi) => {
    ...
    var vF = Ko(),
      ...
      yF = Hh(),
      mF = kh(),
      { ixElements: IF } = _F.IX2ElementsReducer,
  ...
  var za = u((Yk, gg) => {
    var hg = Ka()
    function v1(e, t, r) {
      t == '__proto__' && hg ? hg(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r)
    }
    gg.exports = v1
  })
  var yg = u(($k, _g) => {
  ...
  var t_ = u((pj, e_) => {
    ...
    function U2(e, t, r) {
      ...
      return (
        G2(r) && ((n = 'leading' in r ? !!r.leading : n), (i = 'trailing' in r ? !!r.trailing : i)),
        F2(e, t, { leading: n, maxWait: t, trailing: i })
      )
    }
    e_.exports = U2
  })
  var vi = u((ae) => {
    ...
    var vG = ({ rawData: e, defer: t }) => ({ type: K2, payload: { defer: t, rawData: e } })
    ...
    var hG = (e) => ({ type: Y2, payload: { actionListId: e } })
    ae.stopRequested = hG
    var gG = () => ({ type: $2 })
    ae.clearRequested = gG
    var _G = (e, t) => ({ type: Q2, payload: { target: e, listenerParams: t } })
    ...
    ae.instanceAdded = OG
    var SG = (e, t) => ({ type: nG, payload: { instanceId: e, time: t } })
    ae.instanceStarted = SG
    var bG = (e) => ({ type: iG, payload: { instanceId: e } })
    ae.instanceRemoved = bG
    var AG = (e, t, r, n) => ({ type: oG, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } })
    ae.elementStateChanged = AG
    var wG = ({ actionListId: e, isPlaying: t }) => ({ type: aG, payload: { actionListId: e, isPlaying: t } })
    ae.actionListPlaybackChanged = wG
    var RG = ({ width: e, mediaQueries: t }) => ({ type: sG, payload: { width: e, mediaQueries: t } })
  ...
  var a_ = u((xe) => {
    ...
    var NG = Wt(),
      ...
      { IX2_ID_DELIMITER: i_, HTML_ELEMENT: xG, PLAIN_OBJECT: LG, WF_PAGE: o_ } = qG.IX2EngineConstants
    function PG(e, t, r) {
      e.style[t] = r
    }
    function DG(e, t) {
  ...
  var C_ = u((bj, R_) => {
    var cX = A_(),
      ...
      fX = w_
        ? function (e, t) {
            return w_(e, 'toString', { configurable: !0, enumerable: !1, value: cX(t), writable: !0 })
          }
        : lX
    R_.exports = fX
  })
    ...
    function oU(e) {
      return QX(function (t) {
        ...
        for (n = a ? n : r; ++n < r; ) {
          ...
          c && iy(c[0]) && c[1] == (nU | tU | rU | iU) && !c[4].length && c[9] == 1
            ? (a = a[es(c[0])].apply(a, c[3]))
            : (a = o.length == 1 && iy(o) ? a[s]() : a.thru(o))
        }
        return function () {
          var f = arguments,
            E = f[0]
  ...
  var Ny = u((bi) => {
    ...
    var He = Si(Pr()),
      ...
      rn = Ay(({ element: e, nativeEvent: t }) => e === t.target),
      MU = Ay(({ element: e, nativeEvent: t }) => e.contains(t.target)),
      ...
      We = ({ store: e, event: t, element: r, eventStateKey: n }, i) => {
        ...
        return (
          ...
          (0, rs.stopActionGroup)({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: s }),
          (0, rs.startActionGroup)({ store: e, eventId: a, eventTarget: r, eventStateKey: n, actionListId: s }),
          i
        )
      },
      Je = (e, t) => (r, n) => e(r, n) === !0 ? t(r, n) : n,
      nn = { handler: Je(dt, We) },
      Ry = (0, He.default)({}, nn, { types: [ns, by].join(' ') }),
      is = [
      ...
      os = { types: is },
      GU = { PAGE_START: Sy, PAGE_FINISH: Oy },
      tn = (() => {
      ...
      VU = (e) => {
        ...
        return XU(t.getBoundingClientRect(), { left: 0, top: c, right: n, bottom: i - c })
      },
      Cy = (e) => (t, r) => {
        let { type: n } = t.nativeEvent,
          i = [ns, by].indexOf(n) !== -1 ? n === ns : r.isActive,
      ...
      WU = (e) => (t, r) => {
        let n = (0, He.default)({}, r, { elementVisible: VU(t) })
      ...
      gy =
        ...
        (t, r = {}) => {
          ...
          let A = s === Iy ? h >= x + g : h <= x - g,
            w = (0, He.default)({}, r, { percentTop: h, inBounds: A, anchorTop: x, scrollingDown: S })
      ...
      Ti = (e = !0) =>
        (0, He.default)({}, Ry, {
          handler: Je(
            e ? dt : rn,
            Cy((t, r) => (r.isActive ? nn.handler(t, r) : r))
          ),
        }),
      Oi = (e = !0) =>
        (0, He.default)({}, Ry, {
          handler: Je(
            e ? dt : rn,
            Cy((t, r) => (r.isActive ? r : nn.handler(t, r)))
          ),
        }),
      yy = (0, He.default)({}, os, {
        handler: WU((e, t) => {
          ...
          return !a[n.action.config.autoStopEventId] && t.triggered
            ? t
            : (n.eventTypeId === Ty) === r
            ? (We(e), (0, He.default)({}, t, { triggered: !0 }))
            : t
        }),
      }),
      my = 0.05,
      jU = {
        ...
        [bU]: Ti(),
        [AU]: Oi(),
        [PU]: { types: 'ecommerce-cart-open', handler: Je(dt, We) },
        [LU]: { types: 'ecommerce-cart-close', handler: Je(dt, We) },
        [EU]: {
          types: 'click',
          handler: Je(
            dt,
        ...
        [gU]: (0, He.default)({}, nn, { types: 'mousedown' }),
        [_U]: (0, He.default)({}, nn, { types: 'mouseup' }),
        [yU]: {
          types: Ey,
          handler: Je(
            dt,
        ...
        [CU]: {
          ...
          handler: (
            ...
            let { basedOn: a, selectedAxis: s, continuousParameterGroupId: c, reverse: f, restingState: E = 0 } = r,
              { clientX: p = o.clientX, clientY: h = o.clientY, pageX: g = o.pageX, pageY: S = o.pageY } = n,
              b = s === 'X_AXIS',
              x = n.type === 'mouseout',
              A = E / 100,
              w = c,
            ...
            switch (a) {
              ...
              case Bt.EventBasedOn.PAGE: {
                let { scrollLeft: N, scrollTop: C, scrollWidth: q, scrollHeight: G } = tn()
              ...
              default: {
                ...
                if (!N && !BU({ left: p, top: h }, C)) break
                ;(I = !0), (A = b ? (p - q) / j : (h - G) / Y)
                break
              }
            }
            return (
              x && (A > 1 - my || A < my) && (A = Math.round(A)),
              (a !== Bt.EventBasedOn.ELEMENT || I || I !== o.elementHovered) &&
                ((A = f ? 1 - A : A), e.dispatch((0, Ii.parameterChanged)(w, A))),
              { elementHovered: I, clientX: p, clientY: h, pageX: g, pageY: S }
            )
          },
        },
        [DU]: {
        ...
        [xU]: {
          ...
          handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, i = { scrollPercent: 0 }) => {
            let { scrollLeft: o, scrollTop: a, scrollWidth: s, scrollHeight: c, clientHeight: f } = tn(),
              {
                basedOn: E,
                selectedAxis: p,
            ...
            if (E === Bt.EventBasedOn.VIEWPORT) {
              let N = I ? o / s : a / c
              return N !== i.scrollPercent && t.dispatch((0, Ii.parameterChanged)(h, N)), { scrollPercent: N }
            } else {
              let N = vy(n, h),
              ...
              return m !== i.scrollPercent && t.dispatch((0, Ii.parameterChanged)(N, m)), { scrollPercent: m }
            }
          },
        },
        [Ty]: yy,
        ...
        [Oy]: { types: 'readystatechange IX2_PAGE_UPDATE', handler: Je(rn, HU(We)) },
        [Sy]: { types: 'readystatechange IX2_PAGE_UPDATE', handler: Je(rn, kU(We)) },
      }
    bi.default = jU
  })
  var as = u((Ct) => {
    ...
    var zU = tt(Pr()),
      ...
      { isPluginType: ls, createPluginInstance: fs, getPluginDuration: yV } = Ly.IX2VanillaPlugins,
      xy = navigator.userAgent,
      mV = xy.match(/iPad/i) || xy.match(/iPhone/),
      IV = 12
    function TV(e) {
      Ht({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: bV }),
        Ht({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: AV }),
        Ht({ store: e, select: ({ ixRequest: t }) => t.stop, onChange: wV }),
        Ht({ store: e, select: ({ ixRequest: t }) => t.clear, onChange: RV })
    }
    function OV(e) {
      Ht({
        store: e,
        ...
        onChange: () => {
          Ni(e), Dy({ store: e, elementApi: we }), Ci({ store: e, allowEvents: !0 }), My()
        },
      })
    }
    function SV(e, t) {
    ...
    function bV({ rawData: e, defer: t }, r) {
      let n = () => {
        Ci({ store: r, rawData: e, allowEvents: !0 }), My()
      }
      t ? setTimeout(n, 0) : n()
    }
    function My() {
    ...
    function AV(e, t) {
      ...
      if (n && i && E && s) {
        ...
        p && (E = dV({ actionList: p, actionItemId: i, rawData: E }))
      }
      if (
        (Ci({ store: t, rawData: E, allowEvents: a, testManual: c }),
        (n && r === et.ActionTypeConsts.GENERAL_START_ACTION) || ss(r))
      ) {
        ds({ store: t, actionListId: n }), Gy({ store: t, actionListId: n, eventId: o })
        let p = ps({ store: t, eventId: o, actionListId: n, immediate: s, verbose: f })
        f && p && t.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: n, isPlaying: !s }))
      }
    }
    function wV({ actionListId: e }, t) {
      e ? ds({ store: t, actionListId: e }) : Xy({ store: t }), Ni(t)
    }
    function RV(e, t) {
      Ni(t), Dy({ store: t, elementApi: we })
    }
    function Ci({ store: e, rawData: t, allowEvents: r, testManual: n }) {
      ...
      t && e.dispatch((0, Oe.rawDataImported)(t)),
        i.active ||
          ...
          r && (PV(e), CV(), e.getState().ixSession.hasDefinedMediaQueries && OV(e)),
      ...
      A.forEach((N) => {
        ...
        q.forEach((G) => {
          ...
          if (((b[ee] = LV(b[ee], C, G)), !S[ee])) {
            S[ee] = !0
            let { config: D } = G
            wi({ config: D, event: h, eventTarget: r, elementRoot: ie, elementApi: we }).forEach((m) => {
        ...
        x.forEach(({ element: N, key: C }) => {
          let q = b[C],
            ...
            ie = cs({ element: N, actionItem: G, elementApi: we }, Y)
          vs({
            store: e,
            element: N,
            eventId: n,
    ...
    var FV = (e, t) => (0, ZU.default)((0, eV.default)(e, t), JU.default),
      ...
      XV = (e) => {
        ...
        return wi({ config: t, elementApi: we })
      }
    function UV({ logic: e, store: t, events: r }) {
      VV(r)
      ...
      ;(0, on.default)(s, (p, h) => {
        let g = r[h],
          { action: S, id: b, mediaQueries: x = o.mediaQueryKeys } = g,
          { actionListId: A } = S.config
        gV(x, o.mediaQueryKeys) || t.dispatch((0, Oe.mediaQueriesDefined)()),
          S.actionTypeId === et.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
            (Array.isArray(g.config) ? g.config : [g.config]).forEach((I) => {
              let { continuousParameterGroupId: N } = I,
                C = (0, Rt.default)(a, `${A}.continuousParameterGroups`, []),
                q = (0, $U.default)(C, ({ id: Y }) => Y === N),
                G = (I.smoothing || 0) / 100,
                j = (I.restingState || 0) / 100
              q &&
                p.forEach((Y, ie) => {
                  let ee = b + us + ie
                  xV({
          ...
          (S.actionTypeId === et.ActionTypeConsts.GENERAL_START_ACTION || ss(S.actionTypeId)) &&
      ...
      let c = (p) => {
          ...
          GV(s, (g, S, b) => {
            let x = r[S],
              A = h.eventState[b],
              { action: w, mediaQueries: I = o.mediaQueryKeys } = x
            if (!Ri(I, h.mediaQueryKey)) return
            let N = (C = {}) => {
              let q = i({ store: t, element: g, event: x, eventConfig: C, nativeEvent: p, eventStateKey: b }, A)
    ...
    function VV(e) {
      ...
      for (let n in e) {
        ...
        t[a] ||
          ((i === et.EventTypeConsts.MOUSE_CLICK || i === et.EventTypeConsts.MOUSE_SECOND_CLICK) &&
      ...
      if (c && c.useFirstGroupAsInitialState) {
        ...
        f.forEach((p) => {
          ...
          let { config: g, actionTypeId: S } = p,
            b =
              (g == null || (h = g.target) === null || h === void 0 ? void 0 : h.useEventTarget) === !0
                ? { target: s.target, targets: s.targets }
                : g,
            x = wi({ config: b, event: s, elementApi: we }),
            A = ls(S)
          x.forEach((w) => {
            let I = A ? fs(S)(w, p) : null
            vs({
              destination: cs({ element: w, actionItem: p, elementApi: we }, I),
              immediate: !0,
              store: e,
              element: w,
              eventId: r,
    ...
    function Xy({ store: e }) {
      ...
      ;(0, on.default)(t, (r) => {
        if (!r.continuous) {
          ...
          Es(r, e), i && e.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }))
        }
      })
    }
    function ds({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: i }) {
      let { ixInstances: o, ixSession: a } = e.getState(),
        s = a.hasBoundaryNodes && r ? we.getClosestElement(r, Ai) : null
      ;(0, on.default)(o, (c) => {
        ...
        if (c.actionListId === i && c.eventId === t && E) {
          ...
          Es(c, e), c.verbose && e.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: i, isPlaying: !1 }))
        }
      })
    }
    function ps({
      ...
      return (
        I.forEach((G, j) => {
          ...
          wi({ config: Y, event: h, eventTarget: r, elementRoot: m, elementApi: we }).forEach((M, X) => {
            let $ = ee ? fs(ie)(M, G) : null,
              te = ee ? yV(ie)(M, G) : null
            q = !0
            let L = C === j && X === 0,
              H = lV({ element: M, actionItem: G }),
              k = cs({ element: M, actionItem: G, elementApi: we }, $)
            vs({
              store: e,
              element: M,
              actionItem: G,
    ...
    function vs(e) {
      ...
      let { store: r, computedStyle: n } = e,
        i = (0, YU.default)(e, nV),
        { element: o, actionItem: a, immediate: s, pluginInstance: c, continuous: f, restingValue: E, eventId: p } = i,
        h = !f,
        g = sV(),
        ...
        C
      if (N && f)
        switch ((t = x.events[p]) === null || t === void 0 ? void 0 : t.eventTypeId) {
      ...
      if (
        (r.dispatch(
          (0, Oe.instanceAdded)(
            (0, zU.default)({ instanceId: g, elementId: A, origin: q, refType: I, skipMotion: N, skipToValue: C }, i)
          )
        ),
        Uy(document.body, 'ix2-animation-started', g),
        s)
      ) {
        WV(r, g)
        return
      }
      Ht({ store: r, select: ({ ixInstances: G }) => G[g], onChange: Vy }),
        h && r.dispatch((0, Oe.instanceStarted)(g, b.tick))
    }
    function Es(e, t) {
      Uy(document.body, 'ix2-animation-stopping', { instanceId: e.id, state: t.getState() })
      ...
      if (Ri(G, N.mediaQueryKey) && (n || r || i)) {
        ...
        if (i) {
          if (b) {
            ...
            A && !j && t.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: S, isPlaying: !1 }))
          }
          Es(e, t)
        }
      }
  ...
  var By = u((yt) => {
    ...
    function YV(e) {
      Wy(), (0, hs.startEngine)({ store: qi, rawData: e, allowEvents: !0 })
    }
    function Wy() {
      ;(0, hs.stopEngine)(qi)
    }
          ...
          switch (m) {
            ...
            case 'remove':
              ;(P = D.attr('data-wf-tabindex-swap')),
                P ? (D.attr('tabindex', P), D.removeAttr('data-wf-tabindex-swap')) : D.removeAttr('tabindex')
              break
          }
            ...
            if (P !== '') {
              ...
              M.length &&
                ...
                window.setTimeout(
                  function () {
                    q(M, function () {
                      I(M, 'add'), M.get(0).focus({ preventScroll: !0 }), I(M, 'remove')
                    })
                  },
                  D ? 0 : 300
                ))
            ...
            if (a) {
              ...
              ;(E = w),
                Math.abs(I) > c &&
                  r &&
                  String(r()) === '' &&
                  (i('swipe', x, { direction: I > 0 ? 'right' : 'left' }), S())
            }
          }
          function g(x) {
  ...
  var em = u((gs) => {
    ...
    function QV(e, t, r, n, i, o, a, s, c, f, E, p, h) {
      return function (g) {
        ...
        p.ajax({ url: h, type: 'POST', data: b, dataType: 'json', crossDomain: !0 })
          .done(function (w) {
      ...
      (tm.exports = function (e, t) {
        ...
        function I(L, H) {
          ...
          U.done.attr('aria-label') || U.form.attr('aria-label', Q),
            ...
            U.done.attr('aria-label') || U.done.attr('aria-label', Q + ' success'),
            U.fail.attr('tabindex', '-1'),
            U.fail.attr('role', 'region'),
            U.fail.attr('aria-label') || U.fail.attr('aria-label', Q + ' failure')
        ...
        function ee(L, H, k, U) {
          ...
          return (
            H === 'password'
              ...
              : L.attr('required')
              ? U
                ? f.test(L.attr('type')) && (E.test(U) || (F = 'Please enter a valid email address for: ' + k))
        ...
        function m(L) {
          ...
          t.each(k, function (J, Ee) {
            f.test(Ee) && (k.EMAIL = J),
              ...
              /^(first[ _-]?name)$/i.test(Ee) && (k.FNAME = J),
              /^(last[ _-]?name)$/i.test(Ee) && (k.LNAME = J)
          }),
          ...
          ;(ce = Q.substring(ce, Q.indexOf('&', ce))),
            (k['b_' + ue + '_' + ce] = ''),
            e
              .ajax({ url: Q, data: k, dataType: 'jsonp' })
              .done(function (J) {
        ...
        function X(L, H) {
          ...
          if (
            ...
            V.on('click keydown', function (_) {
              ...
              J.on('change', function (_) {
                ;(k = _.target && _.target.files && _.target.files[0]),
                  k &&
                    (F.toggle(!1),
                    ce.toggle(!1),
                    Q.toggle(!0),
          ...
          function l(_) {
            ...
            typeof O == 'string' && O.indexOf('InvalidFileTypeError') === 0
              ? (z = _e)
              : typeof O == 'string' && O.indexOf('MaxFileSizeError') === 0 && (z = B),
              de.text(z),
        ...
        function te(L, H, k, U, F) {
          ...
          Q.append('file', k, U),
            e
              .ajax({ type: 'POST', url: L, data: Q, processData: !1, contentType: !1 })
              .done(function () {
                F(null)
              })
              .fail(function (ce) {
    ...
    Nt.define(
      ...
      (nm.exports = function (e, t) {
        ...
        function M(d) {
          return function (V) {
            switch (V.keyCode) {
              ...
              case Le.END:
                return d.open
                  ? (V.keyCode === Le.END ? (d.selectedIdx = d.links.length - 1) : (d.selectedIdx = 0),
                    $(d),
                    V.preventDefault(),
                    V.stopPropagation())
          ...
          return function (V) {
            if (d.open)
              switch (((d.selectedIdx = d.links.index(document.activeElement)), V.keyCode)) {
                ...
                case Le.ARROW_UP:
                  return (
                    (d.selectedIdx = Math.max(-1, d.selectedIdx - 1)), $(d), V.preventDefault(), V.stopPropagation()
                  )
                case Le.ARROW_RIGHT:
                case Le.ARROW_DOWN:
                  return (
        ...
        function pt(d) {
          ...
          return (
            V.animOver ? d.menu.height(K) : d.el.css('position') !== 'fixed' && (K -= d.el.outerHeight(!0)),
        ...
        function de(d, V) {
          ...
          var K = d.config
          if (
            ((K.animation === 'none' || !n.support.transform || K.duration <= 0) && (V = !0),
            I.outro(0, d.el[0]),
          ...
          function v() {
            d.menu.height(''),
              ...
              d.overlay &&
                ...
                (N.length ? d.menu.insertAfter(N) : d.menu.prependTo(d.parent), d.overlay.attr('style', '').hide()),
...
Webflow.require('ix2').init({
  events: {
    'e-167': {
      ...
      target: { id: '9d90fc22-2b7b-f0fe-4a66-1ef69aa467ad', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '9d90fc22-2b7b-f0fe-4a66-1ef69aa467ad', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
    ...
    'e-169': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '9d90fc22-2b7b-f0fe-4a66-1ef69aa467a8', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '9d90fc22-2b7b-f0fe-4a66-1ef69aa467a8', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    'e-171': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64616832c6bcdf19ff8b2022|afa5195f-b3ae-ecec-fd61-807ae959c738',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-179': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6461682483184ca8ecf4fb01|dd2a9d95-483b-8529-857c-9374f0f8c429',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-181': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6461682483184ca8ecf4fb01|10aaf53c-a66b-6530-fa31-5f93900da93d',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-183': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '6461682483184ca8ecf4fb01|616fe0a8-9294-f6c9-fb5c-5a1648599cfe',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-185': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64616832c6bcdf19ff8b2022|149fbb87-641e-e43b-b8f5-938f189381fd',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-187': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64616832c6bcdf19ff8b2022|054ffd05-870a-7926-73a5-ab8d8751204f',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-189': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        id: '64616832c6bcdf19ff8b2022|ce471561-b8dc-f4a1-ddd3-352a74628b14',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-195': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '77033123-8b54-5746-9522-887c2867f6e9', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '77033123-8b54-5746-9522-887c2867f6e9', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    'e-197': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: { id: '77033123-8b54-5746-9522-887c2867f6ee', appliesTo: 'ELEMENT', styleBlockIds: [] },
      targets: [{ id: '77033123-8b54-5746-9522-887c2867f6ee', appliesTo: 'ELEMENT', styleBlockIds: [] }],
      config: {
        loop: false,
        playInReverse: false,
        scrollOffsetValue: null,
    ...
    'e-199': {
      ...
      target: { id: '64605909c0388563ae5d9993', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '64605909c0388563ae5d9993', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
    ...
    'e-201': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: {
        selector: '.in-paragraph-text-link',
        originalId: '64605909c0388563ae5d9993|517c5647-6829-79a3-08e6-a93c5b1b1b33',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-203': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: {
        id: '64605909c0388563ae5d9993|c9ca71a2-129e-939b-d9d7-e2b6a3b86101',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-205': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: {
        selector: '.featured-work-thumbnail-img.ix-hover-effect',
        originalId: '64605909c0388563ae5d9993|7dda1e0b-c7a6-3a4a-a404-160969a78f4d',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-207': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.in-paragraph-text-link.ix-hover-effect',
        originalId: '64605909c0388563ae5d9993|a495de97-1ba0-969a-4e03-da4153253ad7',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-211': {
      ...
      mediaQueries: ['main', 'medium', 'small', 'tiny'],
      target: {
        selector: '.featured-work-thumbnail-img-dark.ix-hover-effect',
        originalId: '64605909c0388563ae5d9993|d1cffd21-e9bb-370d-2a2c-96838b0a24a8',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-215': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: {
        selector: '.all-proj-title-name-link-block.ix-hover-effect',
        originalId: '64605909c0388563ae5d9993|aac56db2-1695-c672-d6b7-6c904f644874',
        appliesTo: 'CLASS',
      },
      targets: [
        {
    ...
    'e-220': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: {
        id: '64605909c0388563ae5d9993|cbd4778d-b772-c2c5-f13e-11c980dabdde',
        appliesTo: 'ELEMENT',
        styleBlockIds: [],
      },
      targets: [
    ...
    'e-222': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '6493e31a5df34d5000a46d72', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '6493e31a5df34d5000a46d72', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-224': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '63ed6944167ef5e91ecd088b', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '63ed6944167ef5e91ecd088b', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-226': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '63ed74a3f50864316f2e909a', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '63ed74a3f50864316f2e909a', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-228': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '640f439c36bcf36e98998b69', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '640f439c36bcf36e98998b69', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-230': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '63ed74ca69e766e9a25c3a7b', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '63ed74ca69e766e9a25c3a7b', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-233': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '63ed74bc1be54932ac8ff09f', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '63ed74bc1be54932ac8ff09f', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-235': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '646194657fd4d2c326f214e3', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '646194657fd4d2c326f214e3', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-237': {
      ...
      mediaQueries: ['main', 'medium', 'small'],
      target: { id: '63ed747b1df61baf3553872c', appliesTo: 'PAGE', styleBlockIds: [] },
      targets: [{ id: '63ed747b1df61baf3553872c', appliesTo: 'PAGE', styleBlockIds: [] }],
      config: [
        {
          continuousParameterGroupId: 'a-40-p',
          selectedAxis: 'X_AXIS',
    ...
    'e-238': {
      ...
      createdOn: 1687723782545,
    },
  },
  actionLists: {
    'a-16': {
      id: 'a-16',
      title: 'navbar hover - ct',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: '.dot-ascend',
                  selectorGuids: ['594adeb4-160b-5d82-cd54-ed3a2c7c9cfd'],
                },
                value: 1,
                unit: '',
              },
      ...
      createdOn: 1684111412395,
    },
    'a-17': {
      id: 'a-17',
      title: 'navbar hover out - ct',
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1684111754172,
    },
    'a-18': {
      id: 'a-18',
      title: 'navbar hover - webdev',
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: 'easeInOut',
                duration: 300,
                target: { useEventTarget: true, id: '64616832c6bcdf19ff8b2022|afa5195f-b3ae-ecec-fd61-807ae959c738' },
                xValue: 1.2,
                yValue: 1.2,
                locked: true,
              },
            },
            {
              ...
              config: {
                ...
                easing: '',
                duration: 300,
                target: { id: '64616832c6bcdf19ff8b2022|898ede80-d73d-f7a5-e0a1-8eae5611f121' },
                xValue: 1.3,
                yValue: 1.3,
                locked: true,
              },
    ...
    'a-21': {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  id: '64616832c6bcdf19ff8b2022|898ede80-d73d-f7a5-e0a1-8eae5611f121',
                },
                xValue: 1,
                yValue: 1,
                locked: true,
      ...
      createdOn: 1684112374128,
    },
    'a-37': {
      id: 'a-37',
      title: 'navbar hover - webdev 6',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-38': {
      id: 'a-38',
      title: 'navbar hover out - webdev 6',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-40': {
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    easing: '',
                    duration: 500,
                    target: { selector: '.cursor-dot', selectorGuids: ['d97fe653-d0f8-8f61-ae79-44da770dd742'] },
                    xValue: -50,
                    xUnit: 'vw',
                    yUnit: 'PX',
                    zUnit: 'PX',
      ...
      createdOn: 1687449425716,
    },
    'a-41': {
      id: 'a-41',
      title: 'Cursor Follow (Circle)',
      continuousParameterGroups: [
        {
          id: 'a-41-p',
          type: 'MOUSE_X',
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    easing: '',
                    duration: 500,
                    target: { selector: '.cursor-circle', selectorGuids: ['9b6d34d4-199e-0a31-6c4a-bbeb9fc64df3'] },
                    xValue: -50,
                    xUnit: 'vw',
                    yUnit: 'PX',
                    zUnit: 'PX',
      ...
      createdOn: 1687449693416,
    },
    'a-45': {
      id: 'a-45',
      title: 'Cursor Expand (Dot)',
      actionItemGroups: [
        {
          actionItems: [
            {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1687453111807,
    },
    'a-47': {
      id: 'a-47',
      title: 'Cursor Shrink (Dot)',
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    'a-48': {
      id: 'a-48',
      title: 'Cursor Expand Invert (Dot)',
      actionItemGroups: [
        {
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 50,
                target: { selector: '.cursor-dot', selectorGuids: ['d97fe653-d0f8-8f61-ae79-44da770dd742'] },
                filters: [{ type: 'invert', filterId: '1490', value: 100, unit: '%' }],
              },
            },
            {
              id: 'a-48-n',
    ...
    'a-49': {
      id: 'a-49',
      title: 'Cursor Shrink Invert (Dot)',
      actionItemGroups: [
        {
          actionItems: [
            {
            ...
            },
            {
              ...
              config: {
                ...
                duration: 100,
                target: { selector: '.cursor-dot', selectorGuids: ['d97fe653-d0f8-8f61-ae79-44da770dd742'] },
                filters: [{ type: 'invert', filterId: '1490', value: 0, unit: '%' }],
              },
            },
          ],
        },
